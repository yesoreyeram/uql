...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "expression_args", "symbols": ["expression_arg", "_", "expression_args"], "postprocess": merge(0,2)},
    {"name": "expression_arg", "symbols": ["num_type"], "postprocess": d => d[0]},
    {"name": "expression_arg", "symbols": ["str_type"], "postprocess": d => d[0]},
    {"name": "expression_arg", "symbols": ["ref_type"], "postprocess": d => d[0]},
    ...
    {"name": "function_arg", "symbols": ["ref_type"], "postprocess": pick(0)},
    {"name": "function_arg", "symbols": ["num_type"], "postprocess": pick(0)},
    ...
    {"name": "summarize_assignment", "symbols": ["summarize_assignment$ebnf$1", "summarize_assignment$ebnf$2", "summarize_function"], "postprocess": d => ({ operator: d[2].operator, alias: d[0][0], args: d[2].args })},
