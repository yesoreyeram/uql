...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "commands$ebnf$1", "symbols": ["commands$ebnf$1", (uqlLexer.has("comment") ? {type: "comment"} : comment)], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "commands$ebnf$2", "symbols": ["commands$ebnf$2", (uqlLexer.has("comment") ? {type: "comment"} : comment)], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "expression_arg", "symbols": [(uqlLexer.has("lparan") ? {type: "lparan"} : lparan), "__", "function_args", "__", (uqlLexer.has("rparan") ? {type: "rparan"} : rparan)], "postprocess": d => ({ type : "value_array", value: d[2] })},
    {"name": "expression_arg", "symbols": [(uqlLexer.has("plus") ? {type: "plus"} : plus)], "postprocess": d => ({ type: "operation", value: "+" })},
    {"name": "expression_arg", "symbols": [(uqlLexer.has("dash") ? {type: "dash"} : dash)], "postprocess": d => ({ type: "operation", value: "-" })},
    {"name": "expression_arg", "symbols": [(uqlLexer.has("mul") ? {type: "mul"} : mul)], "postprocess": d => ({ type: "operation", value: "*" })},
    {"name": "expression_arg", "symbols": [(uqlLexer.has("divide") ? {type: "divide"} : divide)], "postprocess": d => ({ type: "operation", value: "/" })},
    {"name": "expression_arg", "symbols": [(uqlLexer.has("mod") ? {type: "mod"} : mod)], "postprocess": d => ({ type: "operation", value: "%" })},
    {"name": "expression_arg", "symbols": [(uqlLexer.has("gt") ? {type: "gt"} : gt), (uqlLexer.has("assignment") ? {type: "assignment"} : assignment)], "postprocess": d => ({ type: "operation", value: ">=" })},
    {"name": "expression_arg", "symbols": [(uqlLexer.has("gt") ? {type: "gt"} : gt)], "postprocess": d => ({ type: "operation", value: ">" })},
    {"name": "expression_arg", "symbols": [(uqlLexer.has("lt") ? {type: "lt"} : lt), (uqlLexer.has("assignment") ? {type: "assignment"} : assignment)], "postprocess": d => ({ type: "operation", value: "<=" })},
    {"name": "expression_arg", "symbols": [(uqlLexer.has("lt") ? {type: "lt"} : lt)], "postprocess": d => ({ type: "operation", value: "<" })},
    {"name": "expression_arg", "symbols": [(uqlLexer.has("eq") ? {type: "eq"} : eq)], "postprocess": d => ({ type: "operation", value: "==" })},
    {"name": "expression_arg", "symbols": [(uqlLexer.has("ne") ? {type: "ne"} : ne)], "postprocess": d => ({ type: "operation", value: "!=" })},
    {"name": "expression_arg", "symbols": [(uqlLexer.has("assignment") ? {type: "assignment"} : assignment), (uqlLexer.has("tilde") ? {type: "tilde"} : tilde)], "postprocess": d => ({ type: "operation", value: "=~" })},
    {"name": "expression_arg", "symbols": [(uqlLexer.has("exclaim") ? {type: "exclaim"} : exclaim), (uqlLexer.has("tilde") ? {type: "tilde"} : tilde)], "postprocess": d => ({ type: "operation", value: "!~" })},
    ...
    {"name": "expression_arg", "symbols": [(uqlLexer.has("exclaim") ? {type: "exclaim"} : exclaim), {"literal":"matches"}, "_", {"literal":"regex"}], "postprocess": d => ({ type: "operation", value: "!matches regex" })},
    ...
    {"name": "expression_arg", "symbols": [(uqlLexer.has("exclaim") ? {type: "exclaim"} : exclaim), {"literal":"in"}], "postprocess": d => ({ type: "operation", value: "!in" })},
    {"name": "expression_arg", "symbols": [{"literal":"not"}, "_", {"literal":"in"}], "postprocess": d => ({ type: "operation", value: "!in" })},
    {"name": "expression_arg", "symbols": [{"literal":"in"}, (uqlLexer.has("tilde") ? {type: "tilde"} : tilde)], "postprocess": d => ({ type: "operation", value: "in~" })},
    {"name": "expression_arg", "symbols": [(uqlLexer.has("exclaim") ? {type: "exclaim"} : exclaim), {"literal":"in"}, (uqlLexer.has("tilde") ? {type: "tilde"} : tilde)], "postprocess": d => ({ type: "operation", value: "!in~" })},
    {"name": "expression_arg", "symbols": [{"literal":"not"}, "_", {"literal":"in"}, (uqlLexer.has("tilde") ? {type: "tilde"} : tilde)], "postprocess": d => ({ type: "operation", value: "!in~" })},
    {"name": "expression_arg", "symbols": [{"literal":"contains"}], "postprocess": d => ({ type: "operation", value: "contains" })},
    {"name": "expression_arg", "symbols": [(uqlLexer.has("exclaim") ? {type: "exclaim"} : exclaim), {"literal":"contains"}], "postprocess": d => ({ type: "operation", value: "!contains" })},
    ...
    {"name": "expression_arg", "symbols": [(uqlLexer.has("exclaim") ? {type: "exclaim"} : exclaim), {"literal":"contains_cs"}], "postprocess": d => ({ type: "operation", value: "!contains_cs" })},
    ...
    {"name": "expression_arg", "symbols": [(uqlLexer.has("exclaim") ? {type: "exclaim"} : exclaim), {"literal":"startswith"}], "postprocess": d => ({ type: "operation", value: "!startswith" })},
    ...
    {"name": "expression_arg", "symbols": [(uqlLexer.has("exclaim") ? {type: "exclaim"} : exclaim), {"literal":"startswith_cs"}], "postprocess": d => ({ type: "operation", value: "!startswith_cs" })},
    ...
    {"name": "expression_arg", "symbols": [(uqlLexer.has("exclaim") ? {type: "exclaim"} : exclaim), {"literal":"endswith"}], "postprocess": d => ({ type: "operation", value: "!endswith" })},
    ...
    {"name": "expression_arg", "symbols": [(uqlLexer.has("exclaim") ? {type: "exclaim"} : exclaim), {"literal":"endswith_cs"}], "postprocess": d => ({ type: "operation", value: "!endswith_cs" })},
    ...
    {"name": "function_name", "symbols": [{"literal":"noop"}], "postprocess": as_string},
    ...
    {"name": "function_name", "symbols": [{"literal":"sinh"}], "postprocess": as_string},
    {"name": "function_name", "symbols": [{"literal":"cosh"}], "postprocess": as_string},
    {"name": "function_name", "symbols": [{"literal":"tanh"}], "postprocess": as_string},
    {"name": "function_name", "symbols": [{"literal":"asin"}], "postprocess": as_string},
    {"name": "function_name", "symbols": [{"literal":"acos"}], "postprocess": as_string},
    {"name": "function_name", "symbols": [{"literal":"atan"}], "postprocess": as_string},
    {"name": "function_name", "symbols": [{"literal":"atan2"}], "postprocess": as_string},
    {"name": "function_name", "symbols": [{"literal":"asinh"}], "postprocess": as_string},
    {"name": "function_name", "symbols": [{"literal":"acosh"}], "postprocess": as_string},
    {"name": "function_name", "symbols": [{"literal":"atanh"}], "postprocess": as_string},
    {"name": "function_name", "symbols": [{"literal":"abs"}], "postprocess": as_string},
    ...
    {"name": "function_arg", "symbols": [(uqlLexer.has("identifier") ? {type: "identifier"} : identifier)], "postprocess": d => { return { type: "identifier", value: d[0].value } }},
    ...
    {"name": "command_parse_csv", "symbols": [{"literal":"parse"}, (uqlLexer.has("dash") ? {type: "dash"} : dash), {"literal":"csv"}, "__", "command_parse_csv$ebnf$1"], "postprocess": d => d[4]},
    ...
    {"name": "command_parse_xml", "symbols": [{"literal":"parse"}, (uqlLexer.has("dash") ? {type: "dash"} : dash), {"literal":"xml"}, "__", "command_parse_xml$ebnf$1"], "postprocess": d => d[4]},
    ...
    {"name": "command_parse_yaml", "symbols": [{"literal":"parse"}, (uqlLexer.has("dash") ? {type: "dash"} : dash), {"literal":"yaml"}, "__", "command_parse_yaml$ebnf$1"], "postprocess": d => d[4]},
    ...
    {"name": "parse_arg", "symbols": [(uqlLexer.has("dash") ? {type: "dash"} : dash), (uqlLexer.has("dash") ? {type: "dash"} : dash), (uqlLexer.has("identifier") ? {type: "identifier"} : identifier), "__", "str"], "postprocess": d => ({ identifier: d[2].value, value: d[4] })},
    {"name": "parse_arg", "symbols": [(uqlLexer.has("dash") ? {type: "dash"} : dash), (uqlLexer.has("dash") ? {type: "dash"} : dash), (uqlLexer.has("identifier") ? {type: "identifier"} : identifier), "__", "str_type"], "postprocess": d => ({ identifier: d[2].value, value: d[4].value })},
    {"name": "parse_arg", "symbols": [(uqlLexer.has("dash") ? {type: "dash"} : dash), (uqlLexer.has("dash") ? {type: "dash"} : dash), (uqlLexer.has("identifier") ? {type: "identifier"} : identifier), "__", (uqlLexer.has("identifier") ? {type: "identifier"} : identifier)], "postprocess": d => ({ identifier: d[2].value, value: d[4].value })},
    ...
    {"name": "line_comment", "symbols": [(uqlLexer.has("comment") ? {type: "comment"} : comment)], "postprocess": d => ({ type: "comment", value : d[0]?.value || '' })},
    ...
    {"name": "nlo$ebnf$1", "symbols": ["nlo$ebnf$1", (uqlLexer.has("nl") ? {type: "nl"} : nl)], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "nlo", "symbols": ["nlo$ebnf$1"], "postprocess": dispose},
    {"name": "pipeo$ebnf$1", "symbols": []},
    {"name": "pipeo$ebnf$1", "symbols": ["pipeo$ebnf$1", (uqlLexer.has("pipe") ? {type: "pipe"} : pipe)], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "pipeo", "symbols": ["pipeo$ebnf$1"], "postprocess": dispose},
    {"name": "__$ebnf$1", "symbols": []},
    {"name": "__$ebnf$1", "symbols": ["__$ebnf$1", (uqlLexer.has("ws") ? {type: "ws"} : ws)], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "__", "symbols": ["__$ebnf$1"], "postprocess": dispose},
    {"name": "_$ebnf$1", "symbols": [(uqlLexer.has("ws") ? {type: "ws"} : ws)]},
    {"name": "_$ebnf$1", "symbols": ["_$ebnf$1", (uqlLexer.has("ws") ? {type: "ws"} : ws)], "postprocess": (d) => d[0].concat([d[1]])},
